...
# Batch Connect - visit app 

An example Batch Connect app that launches a visit application within a batch job.
...
``` sh 
    singularity pull visit.sif docker://vtarc/bc_vt_visit:latest
```
...
### Packages made available under this [DockerImage](https://hub.docker.com/repository/docker/vtarc/bc_vt_visit) or [Dockerfile](./Dockerfile):
