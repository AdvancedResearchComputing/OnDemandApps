...
%global repo_name bc_osc_qgis
%global app_name bc_osc_qgis
...
Summary:  Batch Connect - OSC QGIS
...
%description
An interactive app designed for OSC OnDemand that launches a QGIS GUI within an XFCE desktop session on an Owens batch node.
