...
# Batch Connect - PSPP app 

An example Batch Connect app that launches a PSPP application within a batch job.
...
``` sh 
    singularity pull pspp.sif docker://vtarc/bc_vt_pspp:latest
```
...
### Packages made available under this [DockerImage](https://hub.docker.com/repository/docker/vtarc/bc_vt_pspp) or [Dockerfile](./Dockerfiles/Dockerfile):
